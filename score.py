...
def scoreMode_redrawAll(app, canvas):
    ...
    # displays desire image
    canvas.create_rectangle(app.width*0.25-100, app.height*0.4-100, app.width*0.25+100, app.height*0.4+100, fill="brown", width=0)
    canvas.create_image(app.width*0.25, app.height*0.4, image=app.heartImg)
